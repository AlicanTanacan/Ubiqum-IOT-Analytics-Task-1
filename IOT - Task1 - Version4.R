...
grid.arrange(plot2, plot1, plot3, plot4, plot5, plot6)

# Analysis by different year periods
CleanData %>% 
  filter(year(DateTime) == 2007) %>%
  ...
  geom_smooth(aes(y = MeanSM3), se = T, color = "yellow") +
  bbc_style() +
  labs(title = "Average Energy Power Used by Month 2007") + 
  ylab("kWh") + 
  xlab("Time") + 
  theme_light() -> plot7
ggplotly(plot7)
...
CleanData %>% 
  ...
  geom_smooth(aes(y = MeanSM3), se = T, color = "yellow") +
  bbc_style() +
  labs(title = "Average Energy Power Used by Month 2008") + 
  ylab("kWh") + 
  xlab("Time") + 
  theme_light() -> plot8
ggplotly(plot8)
...
CleanData %>% 
  ...
  geom_smooth(aes(y = MeanSM3), se = T, color = "yellow") +
  bbc_style() +
  labs(title = "Average Energy Power Used by Month 2009") + 
  ylab("kWh") + 
  xlab("Time") + 
  theme_light() -> plot9
ggplotly(plot9)
...
CleanData %>% 
  ...
  geom_smooth(aes(y = MeanSM3), se = T, color = "yellow") +
  bbc_style() +
  labs(title = "Average Energy Power Used by Month 2010") + 
  ylab("kWh") + 
  xlab("Time") + 
  theme_light() -> plot10
ggplotly(plot10)
