...
### --------------------- by Alican Tanaçan ------------------------ ###
### -------- Version 3: Year 2006 Excluded Data Analysis ----------- ###
...
EnergyConsumptionFullData <- bind_rows(yr_2007, yr_2008, yr_2009, yr_2010)
...
EnergyConsumption$Month <- month(EnergyConsumption$DateTime, label = T)
